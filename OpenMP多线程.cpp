...
int main() {
	...
	for (int i = step; i <= N; i += step) {
        ...
        cout << "数组规模" <<  i << ": " << endl;
		cout << " " << setw(18) << "3线程平均用时：" << setw(20) << time1 / counter1 << endl;
        cout << " " << setw(18) << "5线程平均用时：" << setw(20) << time2 / counter2 << endl;
		cout << " " <<setw(18) << "7线程平均用时：" << setw(20) << time3 / counter3 << endl;
        cout << endl;
	}
	return 0;
}
